...
#         # game params
    ...
    def conv2d(self, x, out_channels, padding):
      return tf.nn.conv2d(x, out_channels, kernel_size=[3,3], padding=padding, use_bias=False)
    ...
    def calculate_loss(self):
        ...
        self.loss_v = tf.compat.v1.losses.softmax_cross_entropy(self.target_vs, tf.reshape(self.v, shape=[-1,3]))
